            ...
            <div class='popupEdit'>
					...
					<div class='content'>
                        ...
                        <label> Delivery address:</label>
                            <textarea name='Address' class='textareaDesc' rows='4' required>" . $row['custaddress'] ."</textarea><br>
                        <label> Contact number:</label>
                            <input type='text' name='Contact' class='prodContent' value='" . $row['custnumber'] . "' required/><br><br><br>
