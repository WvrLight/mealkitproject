...
<body>
    ...
    <div class="aboutus-wrapper">
        <div class="termscons_des">
            ...
            <li>
            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Filipino Meal Kits Inc., Quezon City.</p>
            </li>
            <li>
            ...
            <li>
            <p><strong>Website</strong> refers to Filipino Meal Kits, accessible from <a href="filipinomealkits.com" rel="external nofollow noopener" target="_blank">filipinomealkits.com</a></p>
            </li>
            <li>
            <p><strong>You</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</p>
            </li>
            </ul>
            <br><h1>Acknowledgment</h1>
            <p>These are the Terms and Conditions governing the use of this Service and the agreement that operates between You and the Company. These Terms and Conditions set out the rights and obligations of all users regarding the use of the Service.</p>
            <br><p>Your access to and use of the Service is conditioned on Your acceptance of and compliance with these Terms and Conditions. These Terms and Conditions apply to all visitors, users and others who access or use the Service.</p>
            <br><p>By accessing or using the Service You agree to be bound by these Terms and Conditions. If You disagree with any part of these Terms and Conditions then You may not access the Service.</p>
            ...
            <br><h1>&quot;AS IS&quot; and &quot;AS AVAILABLE&quot; Disclaimer</h1>
            ...
            <br><h1>Translation Interpretation</h1>
            <p>These Terms and Conditions may have been translated if We have made them available to You on our Service.
            You agree that the original English text shall prevail in the case of a dispute.</p>
            <br><h1>Changes to These Terms and Conditions</h1>
            ...
            <ul>
            <li>By email: fmk@filipinomealkits.com</li>
            </ul>
            <p>From freeprivacypolicy.com</p>
    </div>
    <div id="footer">
